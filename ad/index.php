                ...
                <ul class="sidebar-menu" data-widget="tree">
					...
					<li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="document/Menu Makan.pdf" download><i class="fa fa-circle-o"></i> Food Schedule</a></li>
                    ...
                    <section class="col-lg-12 connectedSortable">
                        ...
                        <div class="box box-info">
                            ...
                            <div class="box-body">
                                <!-- Schedule here -->
								<p class="box-title">
									<strong class="box-title"><i class="fa fa-book margin-r-5"></i> Schedule Green</strong>
								</p>
								<div class="row margin-bottom">
									<div class="col-sm-12">
									<img class="img-responsive" src="../image/jadual1.jpg" alt="Photo">
									</div>
									<!-- /.col -->
								</div>
								<!-- /.row -->
								...
								<hr>
								<p class="box-title">
									<strong class="box-title"><i class="fa fa-book margin-r-5"></i> Schedule Yellow</strong>
								</p>
								<div class="row margin-bottom">
									<div class="col-sm-12">
									<img class="img-responsive" src="../image/jadual2.jpg" alt="Photo">
									</div>
									<!-- /.col -->
								</div>
								<!-- /.row -->
