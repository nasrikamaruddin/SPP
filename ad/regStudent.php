<?php
	...
	if(isset($_POST['registerStudent'])) {
		...
		if($pIC == '')
			$errMsg = 'please enter  I/C number';
		if($pNoPhone == '')
			$errMsg = 'please enter  number phone';
		if($pAddress == '')
		...
		if($errMsg == ''){
			try {
				$stmt = $connect->prepare('INSERT INTO person (pName, uniqueID, pIC, pAge, pNoPhone, pAddress, pEmail, pRole, pStatus, pUsername, pPassword) VALUES (:pName, :uniqueID, :pIC, :pAge, :pNoPhone, :pAddress, :pEmail, :pRole, :pStatus, :pUsername, :pPassword)');
				$stmt->execute(array(
				...
				$stmt1 = $connect->prepare("SELECT personID FROM person where pIC = '$pIC'");
				$stmt1->execute();
				...
				foreach($data as $row):
				$ref_personID = $row['personID'];
				endforeach ;
				//________________________________________________________________________//
				
				$stmt2 = $connect->prepare('INSERT INTO student (studentID, personID) VALUES (:studentID, :personID)');
				$stmt2->execute(array(
					
					':studentID' => $uniqueID,
					':personID' => $ref_personID
					));
                ...
                <ul class="sidebar-menu" data-widget="tree">
					...
					<li  class="active treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li class="active"><a href="regStudent.php"><i class="fa fa-circle-o"></i> Register Student</a></li>
					...
					<div class="box-body">
						<form method="post">
							...
							<div class="form-group">
							  ...
							  <input type="text" class="form-control" name="uniqueID" placeholder="Full Name">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
							  ...
							  <input type="text" class="form-control" name="pIC" placeholder="I/C Number">
							</div>
							<div class="form-group">
							  <label>Age</label>
							...
							<div class="form-group">
							  <label>Address</label>
							   <textarea class="form-control" rows="3" name="pAddress" placeholder="Enter ..."></textarea>
							</div>
							<div class="form-group">
							  <label>Email</label>
							  <input type="email" class="form-control" name="pEmail" placeholder="Email Address">
							</div>
							<input type="hidden" class="form-control" name="pRole" value="student" hidden>
							<input type="hidden" class="form-control" name="pStatus" value="active" hidden>
							<div class="form-group">
							...
							<div class="box-footer">
								<input type="hidden" name="registerStudent" value="registerStudent">
