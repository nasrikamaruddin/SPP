<?php
	...
	if(isset($_POST['registerClass'])) {
		...
		if($errMsg == ''){
			try {
				$stmt = $connect->prepare('INSERT INTO class (className, form) VALUES (:className, :form)');
				$stmt->execute(array(
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="active treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li class="active"><a href="registerClass.php"><i class="fa fa-circle-o"></i> Register Class</a></li>
					...
					<div class="box-body">
						<form method="post">
							...
							<div class="form-group">
							  <label>Name</label>
							  <input type="text" class="form-control" name="className" placeholder="Name of class">
							</div>
							<!-- select -->
							<div class="form-group">
							  <label>Form</label>
							...
							<div class="box-footer">
								<input type="hidden" name="registerClass" value="registerClass">
