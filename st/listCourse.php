            ...
            <section class="content">
                ...
                <div class="row">
                    ...
                    <section class="col-lg-12 connectedSortable">
						...
						$stmt = $connect->prepare("SELECT enroll.enrollID AS enrollID, enroll.studentID, course.courseID, course.courseName AS courseName, course.courseDesc AS courseDesc 
													FROM enroll inner join course ON enroll.courseID = course.courseID
                        ...
                        <div class="box box-info">
                            <div class="box-header with-border">
									...
									<h3 class="box-title"><?=$row['courseName'] ?></h3>
                            </div>
                            <div class="box-body">
                                <!-- Schedule here -->
								<p class="box-title">
									<strong class="box-title"><i class="fa fa-book margin-r-5"></i> <?=$row['courseName'] ?></strong>
								</p>
								...
								<!-- /.row -->
								<form action="listHomework.php" method="post">
									...
									<button type="submit" class="btn bg-olive btn-block "><?=$row['courseName'] ?></button>
								</form>
