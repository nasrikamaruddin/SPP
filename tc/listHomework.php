<?php
	...
	if(isset($_POST['homeworkTask'])) {
		...
		if($data == '')
			$errMsg = 'file missing';
		if($courseID == '')
			$errMsg = 'course unique ID missing';
		if($hmTitle == '')
			$errMsg = 'Title missing';
		if($hmDesc == '')
			$errMsg = 'Description missing';
		if($hmEndDate == '')
			$errMsg = 'End Date missing';
		//if($file == '')
			//$errMsg = 'file missing';
		
		// Create the SQL query
        $query = "INSERT INTO homework (courseID, hmTitle, hmDesc, fileName, file,  hmEndDate)
            VALUES ({$courseID}, '{$hmTitle}', '{$hmDesc}', '{$fileName}', '{$data}', '{$hmEndDate}')";
                    ...
                    <section class="col-lg-12 connectedSortable">
						...
						<div class="box box-warning">
							<div class="box-header with-border">
								<h3 class="box-title">Create Homework <b>( <?=$courseName ?> ) </b></h3>
							</div>
							<!-- /.box-header -->
							<!-- form start -->
							<form method="post" enctype="multipart/form-data">
								<div class="box-body">
									...
									<input type="hidden" class="form-control" name="courseID" value="<?=$courseID ?>" placeholder="Enter title">
									
									<div class="form-group">
									  <label>Title</label>
									  <input type="text" class="form-control" name="hmTitle" placeholder="Enter title">
									</div>
									<div class="form-group">
									  <label>Description</label>
									  <textarea class="form-control" rows="3" name="hmDesc" placeholder="Enter Description ..."></textarea>
									  ...
									  <div class="form-group">
										...
										<div class="input-group">
										  ...
										  <input type="text" class="form-control pull-right" name="hmEndDate" id="reservationtime">
										</div>
										<!-- /.input group -->
									  </div>
									  <!-- /.form group -->
							  ...
							  <!-- /.box-body -->
								...
								<div class="box-footer">
									<input type="hidden" class="form-control pull-right" value="homeworkTask" name="homeworkTask">
									...
									<div class="box-body">
										...
										<table class="table table-bordered table-striped">
											...
											<tr>
												...
												<td>
													<form action="submittedHW.php" method="post">
														<input type="hidden" name="courseID" value="<?=$row['courseID'] ?>" >
														<input type="hidden" name="courseName" value="<?=$row['courseName'] ?>" >
														<input type="hidden" name="homeworkID" value="<?=$row['homeworkID'] ?>" >
														<input type="hidden" name="hmTitle" value="<?=$row['hmTitle'] ?>" >
														<input type="hidden" name="hmDesc" value="<?=$row['hmDesc'] ?>" >
														<input type="hidden" name="hmEndDate" value="<?=$row['hmEndDate'] ?>" >
														<input type="hidden" name="trans1" value="trans1">
														<button type="submit" class="btn bg-olive btn-block ">Click me!..</button>
													</form>
												</td>
											</tr>
										</table>
